...
\begin{description}
	...
	\item[FR2 - Tabular Processing:]
		...
		The software shall support the training of various \gls{model} versions, including the TabDDPM diffusion \gls{model}, variations of TabDDPM and other non-diffusion baseline models.
...
\begin{enumerate}
	...
	\item The TabSynDex metric contains a machine learning efficacy metric based upon a set of standard machine learning models.
\end{enumerate}
