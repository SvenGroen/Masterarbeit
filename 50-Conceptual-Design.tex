...
The file is stored as a \gls{toml} \glsadd{tomlaccr} file (short for "Tom's Obvious, Minimal Language") \cite{werner2021TOMLTomObvious}, which contains sections, indicated by squared brackets. 
