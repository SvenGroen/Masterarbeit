...
The proposed solution for this is to change the objective function from the generator from the minimization function \cite{eqn:generator} to a maximization of $logD(G(z))$.
