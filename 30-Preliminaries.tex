...
$L_T$ consists of $q(x_{T}|x_0)$ is a noising forward process that has no learnable parameters and $p(x_T)$ is gaussian distributed noise.
...
Both terms have a closed form solution with:
